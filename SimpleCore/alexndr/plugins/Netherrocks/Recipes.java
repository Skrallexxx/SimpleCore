...
public class Recipes 
{
	...
	{
		try{doOreDictRecipes(); LogHelper.verboseInfo("Netherrocks", "All OreDictionary entries were added successfully.");}
		catch(Exception e){LogHelper.severe("Netherrocks", "OreDictionary entries were not added successfully. This is a serious problem!"); e.printStackTrace();}
	}
	
	public static void initialize()
	{
		try{doRecipes(); LogHelper.verboseInfo("Netherrocks", "All recipes were added successfully.");}
		catch(Exception e){LogHelper.severe("Netherrocks ", "Recipes were not added successfully. This is a serious problem!"); e.printStackTrace();}
	}
