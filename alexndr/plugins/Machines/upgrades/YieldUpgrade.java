...
public class YieldUpgrade extends SimpleItem{
	 ...
	 */
	public YieldUpgrade(Plugin plugin, Item category, int tier, float modifier) {
		super(plugin, category);
		this.tier = tier;
	...
	@Override
	public YieldUpgrade setConfigEntry(ConfigItem entry) {
		this.entry = entry;
	...
	public YieldUpgrade addTooltip() {
		TooltipHelper.addTooltipToItem(this, EnumChatFormatting.RED + "+" + (int)(this.modifier * 100) + "% " + StatCollector.translateToLocal("machines.yieldUpgrade.info"));
		return this;
	}
