...
{	
	...
	{
		copper_ingot = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("copper_ingot");
		tin_ingot = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("tin_ingot");
		mythril_ingot = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("mythril_ingot");
		adamantium_ingot = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("adamantium_ingot");
		onyx_gem = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("onyx_gem");
		mythril_rod = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("mythril_rod");
		onyx_rod = new SimpleItem().modId("simpleores").setTab(TabHelper.materialsTab()).setUnlocalizedName("onyx_rod");
	...
	{
		copper_ore = new SimpleBlock(Material.rock).modId("simpleores").setTab(TabHelper.blocksTab()).setHarvestLvl("pickaxe", Settings.copperOreHarvestLevel).setHardness(Settings.copperOreHardness).setResistance(Settings.copperOreResistance).setBlockName("copper_ore");
		tin_ore = new SimpleBlock(Material.rock).modId("simpleores").setTab(TabHelper.blocksTab()).setHarvestLvl("pickaxe", Settings.tinOreHarvestLevel).setHardness(Settings.tinOreHardness).setResistance(Settings.tinOreResistance).setBlockName("tin_ore");
		mythril_ore = new SimpleBlock(Material.rock).modId("simpleores").setTab(TabHelper.blocksTab()).setHarvestLvl("pickaxe", Settings.mythrilOreHarvestLevel).setHardness(Settings.mythrilOreHardness).setResistance(Settings.mythrilOreResistance).setBlockName("mythril_ore");
		adamantium_ore = new SimpleBlock(Material.rock).modId("simpleores").setTab(TabHelper.blocksTab()).setHarvestLvl("pickaxe", Settings.adamantiumOreHarvestLevel).setHardness(Settings.adamantiumOreHardness).setResistance(Settings.adamantiumOreResistance).setBlockName("adamantium_ore");
		onyx_ore = new SimpleBlock(Material.rock).modId("simpleores").setTab(TabHelper.blocksTab()).setHarvestLvl("pickaxe", Settings.onyxOreHarvestLevel).setHardness(Settings.onyxOreHardness).setResistance(Settings.onyxOreResistance).setBlockName("onyx_ore");
		copper_block = new SimpleBlock(Material.iron).modId("simpleores").setTab(TabHelper.blocksTab()).setBeaconBase(true).setHardness(Settings.copperBlockHardness).setResistance(Settings.copperBlockResistance).setBlockName("copper_block");
		tin_block = new SimpleBlock(Material.iron).modId("simpleores").setTab(TabHelper.blocksTab()).setBeaconBase(true).setHardness(Settings.tinBlockHardness).setResistance(Settings.tinBlockResistance).setBlockName("tin_block");
		mythril_block = new SimpleBlock(Material.iron).modId("simpleores").setTab(TabHelper.blocksTab()).setBeaconBase(true).setHardness(Settings.mythrilBlockHardness).setResistance(Settings.mythrilBlockResistance).setBlockName("mythril_block");
		adamantium_block = new SimpleBlock(Material.iron).modId("simpleores").setTab(TabHelper.blocksTab()).setBeaconBase(true).setHardness(Settings.adamantiumBlockHardness).setResistance(Settings.adamantiumBlockResistance).setBlockName("adamantium_block");
		onyx_block = new SimpleBlock(Material.iron).modId("simpleores").setTab(TabHelper.blocksTab()).setBeaconBase(true).setHardness(Settings.onyxBlockHardness).setResistance(Settings.onyxBlockResistance).setBlockName("onyx_block");
	}
